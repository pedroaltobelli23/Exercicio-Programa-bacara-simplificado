...
quantos_baralhos = int(input('Quantos baralhos tera o jogo?(6 ou 8): '))

#quantas fichas o jogador tem no total
...
while jogo :
    ...
    lista_de_cartas = lista_com_valores*4*quantos_baralhos
